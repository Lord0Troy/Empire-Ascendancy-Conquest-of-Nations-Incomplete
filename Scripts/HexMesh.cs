...
public class HexMesh : MonoBehaviour {
    ...
    // Clear the mesh data and initialize lists
    public void Clear () {
        hexMesh.Clear();
    ...
    // Apply the mesh data and recalculate normals
    public void Apply () {
    ...
    // Add a triangle to the mesh with perturbed vertices
    ...
    // Add a triangle to the mesh with unperturbed vertices
    ...
    // Add cell data for a triangle with uniform weights
    public void AddTriangleCellData (Vector3 indices, Color weights) {
        AddTriangleCellData(indices, weights, weights, weights);
    }

    // Add a quad to the mesh with perturbed vertices
    ...
    // Add a quad to the mesh with unperturbed vertices
    ...
    // Add UV coordinates for a quad using float values
    ...
    // Add UV2 coordinates for a quad using float values
    ...
    // Add cell data for a quad with two different weights
    public void AddQuadCellData (
    ...
    // Add cell data for a quad with uniform weights
