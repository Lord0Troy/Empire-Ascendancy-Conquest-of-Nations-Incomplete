...
public class HexFeatureManager : MonoBehaviour {
    ...
    // Collections of different feature types
    ...
    // Prefabs for wall tower and bridge
    public Transform wallTower, bridge;

    // Array of special features
    public Transform[] special;

    // Container for instantiated features
    Transform container;

    // Clears all features by destroying the container and creating a new one
    public void Clear () {
        if (container) {
    ...
    // Applies the wall mesh
    public void Apply () {
        walls.Apply();
    }

    // Picks a prefab from a collection based on level, hash, and choice
    ...
    // Adds a bridge between two road centers
    ...
    // Adds a feature to a hex cell at a given position
    ...
    // Adds a special feature to a hex cell at a given position
    ...
    // Adds a wall segment between two sets of edge vertices
    public void AddWall (
    ...
    // Adds a wall segment between three cells
    public void AddWall (
    ...
    // Adds a wall segment between four points
    void AddWallSegment (
    ...
    // Adds a wall segment between a pivot and two other points
    void AddWallSegment (
    ...
    // Adds a wall cap between two points
    ...
    // Adds a wall wedge between three points
